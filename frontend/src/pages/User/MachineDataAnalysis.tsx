    ...
    <div className="p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Monitor real-time data from your connected devices.
          </p>
        </div>
      </div>
      ...
      {error && (
        <div className="bg-red-50 border border-red-200 text-red-600 rounded-lg p-4 mb-6">
          <p className="font-medium">Error loading Device solutions:</p>
      ...
      {!loading && !error && solutions.length === 0 && (
        <div className="bg-gray-50 border border-gray-100 text-gray-600 rounded-lg p-6 text-center mb-6">
          ...
          <p className="text-sm mt-1">
            You can begin by configuring analysis solutions to see device data here.
          </p>
        </div>
      )}
