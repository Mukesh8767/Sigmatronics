...
export const UserProfile: React.FC = () => {
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
        ...
        <div className="border-t border-gray-100 pt-4">
          ...
          >
            ...
            <ChevronDown
              className={`w-5 h-5 text-gray-500 transition-transform ${assignModeUserId === subUser._id ? "rotate-180" : ""
                }`}
            />
          </button>
  ...
  return (
    <UserWrapper>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8 bg-white">
        <div className="text-center mb-6">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Account Management</h1>
          <p className="text-lg text-gray-600">Manage your profile and team members</p>
        </div>
        ...
        {profileLoading ? (
          ...
          <div className="relative bg-white text-gray-900 rounded-3xl shadow-2xl p-8 mb-12 overflow-hidden border border-gray-200">
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-50 rounded-full -translate-y-32 translate-x-32"></div>
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-emerald-50 rounded-full translate-y-24 -translate-x-24"></div>
            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-gray-900 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200"
              >
