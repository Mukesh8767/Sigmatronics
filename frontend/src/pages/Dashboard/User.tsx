...
const ActionCard: React.FC<ActionCardProps> = ({
  ...
  >
    <div
      className={`w-12 h-12 bg-gradient-to-r ${gradient} rounded-xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform duration-200`}
    >
      {icon}
    </div>
...
export function UserDashboard() {
  ...
  const { today, thisWeek } = useAnomalyStats(alerts.alerts);
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <StatCard title="Weekly Anomalies" value={thisWeek} icon={<Activity size={24} />} />
          </div>
